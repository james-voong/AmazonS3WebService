 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webService/", wsdlLocation = "http://localhost:8080/WebService?wsdl")
    ...
    extends Service
{
    ...
    public WebServiceInterface getWebServiceImplPort() {
        return super.getPort(new QName("http://webService/", "WebServiceImplPort"), WebServiceInterface.class);
    }
    ...
    public WebServiceInterface getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService/", "WebServiceImplPort"), WebServiceInterface.class, features);
    }
